...
async function transcribe(pcmInt16Buffer, modelPath, debug) {
  ...
  const result = await whisperTranscribe(whisperOptions(toFloat32Samples(pcmInt16Buffer), modelPath));
...
module.exports = { transcribe, loadModel, createWavBuffer, toFloat32Samples };
